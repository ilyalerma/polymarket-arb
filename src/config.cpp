...
Config load_config_from_env() {
  ...
  config.game_loser_ask_max = env_double("PM_GAME_LOSER_ASK_MAX", config.game_loser_ask_max);
  config.game_winner_bid_min = env_double("PM_GAME_WINNER_BID_MIN", config.game_winner_bid_min);
